...
const Navbar = () => {
  ...
  return (
    ...
    <div className='bg-indigo-700 p-5 border-b-[1px] border-indigo-500'>
      <ul className='flex justify-between items-center gap-2 sm:gap-6 md:gap-8 px-6 sm:px-12 md:px-24'>
        ...
        <li className='hidden md:block text text-2xl text-white font-bold'>React Jobs</li>
        </div>
